...
function AdminLayoutContent({ children }: { children: React.ReactNode }) {
  ...
  const isThirdLevelOrDeeper = pathSegments.length > 2;
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Overlay */}
      {!isThirdLevelOrDeeper && sidebarOpen && (
        <div
      ...
      <main
        className={cn(
          'min-h-screen',
          !isThirdLevelOrDeeper && 'pt-16 lg:pt-0',
          !isThirdLevelOrDeeper && (isRTL ? 'lg:mr-64' : 'lg:ml-64'),
        )}
      >
